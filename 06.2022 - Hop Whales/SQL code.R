...
1)
    ...
    #   count(distinct(tt.origin_from_address)) as user_addresses,
    #   count(tt.origin_from_address) as transactions,
    #   AVG(tt.amount_usd) as avg_amount_usd
    ...
    #   'ETH' as symbol,
    #   el.event_inputs:chainId as recipient_chainId,
    #   count(distinct(et.origin_from_address)) as user_addresses,
    #   count(et.origin_from_address) as transactions,
    #   AVG(et.amount_usd) as avg_amount_usd
...
2)
    ...
    #   else 'arbitrum'	
    #   end as L2,
    #   count(distinct(origin_from_address)) as user_addresses,
    #   count(origin_from_address) as transactions,
